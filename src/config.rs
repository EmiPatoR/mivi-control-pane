...
impl Config {
    pub fn load() -> Result<Self, String> {
        Ok(Config {
            ...
            health_check_interval: Duration::from_millis(env_u64("HEALTH_CHECK_INTERVAL_MS", 500)?),
            heartbeat_interval: Duration::from_millis(env_u64("HEARTBEAT_INTERVAL_MS", 500)?),
